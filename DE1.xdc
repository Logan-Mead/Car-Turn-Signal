...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {R3}]                           
...
set_property PACKAGE_PIN U19 [get_ports {R1}]
...
set_property PACKAGE_PIN N3 [get_ports {L1}]                                
	set_property IOSTANDARD LVCMOS33 [get_ports {L1}]
set_property PACKAGE_PIN P1 [get_ports {L2}]
	set_property IOSTANDARD LVCMOS33 [get_ports {L2}]
set_property PACKAGE_PIN L1 [get_ports {L3}]
